...
class _RemindersScreenState extends State<RemindersScreen> {
  ...
  Future<void> _loadReminders() async {
    ...
    final reminders =
        await _repository.getRemindersForCar(carId);
  ...
  _ReminderStatus _statusFor(CarReminder reminder) {
    ...
    if (dueDateText != null) {
      ...
      if (dueDate != null) {
        ...
        final difference =
            dueDate.difference(currentDay).inDays;
        ...
        child: ListView(
          ...
          children: [
            AppSectionTitle(
              ...
              subtitle:
                  'Terminy według daty i przebiegu pojazdu.',
            ),
